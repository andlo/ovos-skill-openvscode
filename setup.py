...
URL = "https://github.com/andlo/ovos-skill-openvscode"
SKILL_CLAZZ = "OpenvscodeServer"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-openvscode"  # pip install PYPI_NAME
